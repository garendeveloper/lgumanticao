<script src="admintemplate/js/excanvas.min.js"></script> 
...
<script src="admintemplate/js/maruti.js"></script> 
<script src="admintemplate/js/maruti.dashboard.js"></script> 
<script src="admintemplate/js/maruti.chat.js"></script> 
